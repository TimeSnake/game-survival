...
public enum StatisticReward implements Reward {
  ...
  BLOCK_BREAK("Miner", Statistic.MINE_BLOCK, 100000,
      new ExItemStack(Material.DIAMOND_PICKAXE).setDamage(1)),
  ...
  TRAIN_DRIVER("Train-Driver", Statistic.MINECART_ONE_CM, 10000,
      new ExItemStack(Material.POWERED_RAIL, 64)),
  ...
  DOORBELL_PRANK("Doorbell-Prank", Statistic.BELL_RING, 11,
      ExItemStack.getPotion(ExItemStack.PotionMaterial.SPLASH
  ...
  SCOUT("Scout", Statistic.INTERACT_WITH_CAMPFIRE, 4,
      new ExItemStack(Material.LEATHER_HELMET).unbreakable()),
  ...
  CAPTAIN("Captain", Statistic.BOAT_ONE_CM, 100000,
      new ExItemStack(Material.DIAMOND_BOOTS).addEnchantments(
          new Tuple<>(Enchantment.DEPTH_STRIDER, 4))),
